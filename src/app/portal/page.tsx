  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-2xl flex-col gap-4 px-6 py-12">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-semibold text-ink">Your portal</h1>
        <form action={signOut}>
      ...
      <p className="text-ink-muted">Signed in as {profile.full_name}.</p>
      <p className="rounded-md border border-hairline bg-white px-4 py-3 text-sm text-ink-muted">
        Your tax organizer will appear here once your firm sends one.
      </p>
    </main>
  );
}
